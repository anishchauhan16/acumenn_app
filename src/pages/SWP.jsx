    ...
    <section className="flex row max-w-7xl mx-auto">
      ...
      <div className="place-items-center w-full bg-white sm:px-8 px-4 py-3 border-b border-b-[#e6ebf4]">
        <h1 className="text-center font-extrabold text-[#222328] text-[22px] w-15 h-18">
          Monthly SWP For Lumpsum Investment
        </h1>
            ...
            <form>
              ...
              <div class="mb-4">
                ...
                <input
                  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  type="text"
                  placeholder="Enter intial investment in Rs."
                />
              </div>
              <div class="mb-4">
              ...
              <div class="mb-4">
                ...
                <input
                  ...
                  id="stepUpPercentage"
                  type="text"
                  placeholder="Enter inflation rate in %"
                />
              </div>
              <div class="mb-4">
                <label
